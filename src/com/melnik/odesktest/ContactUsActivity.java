...
public class ContactUsActivity extends SherlockFragmentActivity {
	...
	protected void onCreate(Bundle arg0) {
		...
		backButton = (Button) findViewById(R.id.contact_us_header);
		...
		menu = MySlidingMenu.getMenu(this, getString(R.string.menu_contact_us));
